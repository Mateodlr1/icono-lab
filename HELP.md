...
* The following dependencies are not known to work with Spring Native: 'Spring Configuration Processor, Spring Boot DevTools, Spring for GraphQL'. As a result, your application may not work as expected.
...
```
$ docker run --rm -p 8080:8080 icono-lab-1:0.0.1-SNAPSHOT
```
